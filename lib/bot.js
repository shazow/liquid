...
Bot.prototype.handleRemoteOrderbook = function(orders, callback) {
    ...
    var budget = order.getBudget(this.originExchange.balance, this.remoteExchange.balance, this.premium, budgetPadding);
 ...
 */
SampleHistory.prototype.add = function(value) {
...
/**
 * Remove the oldest value from the sample history.
 */
SampleHistory.prototype.pop = function() {
