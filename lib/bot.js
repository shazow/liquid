...
Bot.prototype.start = function() {
    this.reset(function() {
        ...
        // Origin 'trade' event should trigger instructOriginOrders and execute
        // the recommended orders

        // Remote 'orderbook' event should trigger instructExchangeOrders and
        // execute the recommended orders
    });
};
