...
Bot.prototype.handleRemoteOrderbook = function(orders, callback) {
    ...
    if (!bot.originExchange.resources.acquire('requests', true /* exclusive */)) {
    ...
    var using = bot.originExchange.resources.using('requests');
    if (using > 1) {
        ...
        bot.originExchange.resources.release('requests');
        return;
    }
