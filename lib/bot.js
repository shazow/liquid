...
Bot.prototype.handleOriginTrade = function(order, callback) {
    ...
    var bot = this;
    var premium = bot.premium || 1.0;
    if (bot.remoteOrderDiscount) {
        // Stack the discount onto the premium, since it will be inverted anyways.
        premium += bot.remoteOrderDiscount;
    }

    var newOrder = order.clone({}, premium, /* invertType */ true);
