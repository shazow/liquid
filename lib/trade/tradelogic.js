...
/**
  ...
  * @param {{source: string, bids: Array.<Order>, asks: Array.<Order>}} orderBook -
...
TradeLogic.instructBitmeOrders = function(state, orderBook, premium) {
    ...
    orders.forEach(function(order) {
        // If a bid is placed by a customer that matches an ask on Bitme, Bitme
        // will resolve this order, causing both to disappear from Bitme's order
        ...
        // exchange. This last step is _only_ done if the order source is _not_
        // Bitme.
