// TODO: Rename this file to instruct.js and get rid of the instruct prefixen?
...
/**
  ...
  */
Trade.recommendOrders = function(orderBook, premium) {
...
/**
  ...
  */
Trade.instructOriginOrders = function(state, orderBook, premium) {
    if (premium === undefined) {
        premium = 1.0;
    }

    var recommendedOrders = Trade.recommendOrders(orderBook, premium);
    var newOrders = [];
...
/**
  ...
  *         The premium multiplier. Should always be set by this point.
  */
Trade.instructExchangeOrders = function(state, orderBook, premium) {
    if (premium === undefined) {
        premium = 1.0;
    }
