var util = require('util'),
    ...
    Transaction = require('../order.js').Transaction,
...
BitmeExchange.prototype.ready = function(callback) {
    ...
    async.series([
        ...
        function loadTransactions(callback) {
            exchange.client.transactionsGet('BTC', 100, 'DESC', 1, function(err, response) {
                if (err) {
                ...
                var transactions = response.transactions.filter(function(t) {
                    return toTransaction(t, placedOrders);
                });
...
var toTransaction = BitmeExchange.toTransaction = function(t, placedOrders) {
    // XXX: This part is tricky, will need extra review.
    ...
    // XXX: Review that this is correct.
    var type = {
        'DEBIT': 'ASK',
        'CREDIT': 'BID'
    ...
    return new Transaction(o.type, o.quantity, o.timestamp);
};
