    ...
    async.series([
        ...
        function loadTransactions(callback) {
            exchange.client.transactionsGet('BTC', 100, 'DESC', 1, function(err, response) {
                ...
                exchange.lastTransactions = response.transactions.filter(function(t) {
                ...
                exchange.debug('Loaded last transactions from previous run:', exchange.lastTransactions.length);
