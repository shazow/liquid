 ...
 * @param {Date=} timestamp When this order was executed.
 */

var Order = module.exports.Order = function(id, type, quantity, rate, state, exchange, timestamp) {
    if (id === undefined) {
...
Order.prototype.clone = function(override, premium, invertType) {
    ...
    var newOrder = new Order(o.id, o.type, o.quantity, o.rate, o.state, o.exchange, o.timestamp);
