...
var patchOrders = module.exports.patchOrders = function(placedOrders, newOrders, tolerance) {
    ...
    // thrashing with tolerance. To improve, we'd need to convert this into a
    // graph optimization problem with a cost function based on number of
    // operations vs acceptable losses.
