...
* @param {number=} maxOrers Maximum number of orders to return.
...
var patchOrders = module.exports.patchOrders = function(placedOrders, newOrders) {
    // FIXME: This is a copout, fix it to be efficient.
    return {
        'cancel': placedOrders,
        'place': newOrders
    }
...
var sortOrders = module.exports.sortOrders = function(orders, meanRate) {
    ...
    return orders.sort(function(a, b) {
        if (abs(meanRate-a.rate) > abs(meanRate-b.rate)) return 1;
        return -1;
    });
};
...
/**
 * Given an orderbook, return the spread calculations.
 *
 * @param {{asks: Array.<Order>, bids: Array.<Order>}} orderbook
 * return {object}
 */
var getSpread = module.exports.getSpread = function(orderbook) {
    // FIXME: Use BigNumber? Do we care?
    var bid = Math.max.apply(null, orderbook.bids.map(function(o) { return o.rate; }));
    var ask = Math.min.apply(null, orderbook.asks.map(function(o) { return o.rate; }));
    var amount = ask - bid;
    var percent = (amount / ask) * 100.0;
